    ...
    <>
      ...
      {rulesModal && (
        <div className='overflow-x-scroll w-screen h-screen fixed top-0 right-0 bottom-0 left-0 z-50'>
          ...
          ></div>
          <div className='absolute top-[30%] left-[49.5%] translate-x-[-50%] translate-y-[-50%] leading-loose bg-gray-900 px-4 sm:px-16 py-8 rounded-md w-5/6 max-w-4xl text-pr-white text-sm md:text-lg lg:text-xl'>
